...
void AddSC_dread_wastes()
{
    ...
    RegisterCreatureAI(npc_shekzeer_clutch_keeper);
    RegisterCreatureAI(npc_mistblade_reapper);
    RegisterCreatureAI(npc_coldbite_matriarch);
    RegisterCreatureAI(npc_ik_thik_whisperer);
    RegisterCreatureAI(npc_ik_thik_clutch_guard);
