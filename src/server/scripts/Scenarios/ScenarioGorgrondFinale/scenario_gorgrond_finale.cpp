...
/*
QUEST 
联盟 36575/趁热打铁 36576/趁热打铁 kill 81074
部落 36573/趁热打铁 36574/趁热打铁 kill 81055
723 对抗指挥官加尔。    38087   0   42412   92  38088   对抗指挥官加尔 1   0   0   25388   38087   0
723 使用神器消灭你的敌人。 38089   1   42413   92  38090   使用神器消灭你的敌人  1   0   0   25389   38089   0
723 使用神器力量击败来犯的敌人。  38091   2   42414   92  38092   击败来袭的敌人 1   0   0   25390   38091   0
723 击败苟克。   38093   3   42415   92  38094   击败苟克    1   0   0   25391   38093   0
723 击败指挥官加尔。    38095   4   42416   92  38096   击败指挥官加尔 1   0   0   25392   38095   0
*/
enum CriteriaTrees
{
...
public:
    ...
    void OnSuccessfulSpellCast(Player* player, Spell* spell) override
    {
        if (player->GetMapId() == 1402 && spell->GetSpellInfo()->Id == SPELL_ACCESS_ARTIFACT)
        {
            //NPC_BECKONED_EARTHTWISTER_85637 = 85637,
            //NPC_BECKONED_EARTHSHAKER_85636 = 85636,
            if (auto npc = player->SummonCreature(NPC_BECKONED_EARTHSHAKER_85636, player->GetPosition(), TEMPSUMMON_TIMED_DESPAWN, 50000))
            {
