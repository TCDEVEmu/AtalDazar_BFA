...
enum OpcodeClient : uint16
{
    ...
    CMSG_MYTHIC_PLUS_REQUEST_LEADERS                  = 0x3090,
    ...
    CMSG_START_MYTHIC_PLUSS                           = 0x3554,
...
enum OpcodeServer : uint16
{
    ...
    SMSG_MYTHIC_PLUS_MODE_COMPLETE                    = 0x2622,
    SMSG_MYTHIC_PLUS_NEW_PLAYER_RECORD                = 0x2628,
    SMSG_MYTHIC_PLUS_NEW_PLAYER_SEASON_RECORD         = 0x2629,
    SMSG_MYTHIC_PLUS_REQUEST_LEADERS_RESULT           = 0x2626,
    SMSG_MYTHIC_PLUS_RESET                            = 0x2621,
    SMSG_MYTHIC_PLUS_REWARDS                          = 0x2623,
    SMSG_MYTHIC_PLUS_START                            = 0x261F,
    SMSG_MYTHIC_PLUS_UPDATE_DEATH_COUNT               = 0x2620,
