...
(10290, 169391, 0, 50, 1, 1, 1, 1, 1, 'mechagon fishing'),
(10290, 167671, 0, 50, 1, 1, 1, 1, 1, 'mechagon fishing'),
(10290, 167670, 0, 50, 1, 1, 1, 1, 1, 'mechagon fishing'),
(10290, 167669, 0, 50, 1, 1, 1, 1, 1, 'mechagon fishing');
...
(10052, 168155, 0, 50, 1, 1, 1, 1, 1, 'nazjatar fishing');

--  Great Sea Ray Mount
UPDATE `reference_loot_template` SET `Chance`= 1,`Comment`='Great Sea Ray Mount'  WHERE `Item`=163131;