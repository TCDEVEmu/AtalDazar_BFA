...
public:
    ...
    class spell_warlock_soul_leech_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_warlock_soul_leech_SpellScript);
        ...
        void Register()
        {
            AfterHit += SpellHitFn(spell_warlock_soul_leech_SpellScript::HandleAfterHit);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_warlock_soul_leech_SpellScript();
    }
};
