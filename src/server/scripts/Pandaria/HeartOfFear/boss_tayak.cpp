        ...
        struct boss_tayakAI : public BossAI
        {
            ...
            void EnterEvadeMode(EvadeReason why) override
            {
                if (instance)
                {
                    ...
                    for (auto&& itr : candles)
                    {
                        ...
                        itr->RemoveNpcFlag(UNIT_NPC_FLAG_SPELLCLICK);
                    }
                }
            ...
            void DamageTaken(Unit* /*attacker*/, uint32& damage) override
            {
                ...
                if (me->HealthBelowPct(20) && Phase == PHASE_NORMAL)
                {
                    ...
                    for (auto&& itr : candles)
                        itr->AddNpcFlag(UNIT_NPC_FLAG_SPELLCLICK);
                }
...
void AddSC_boss_tayak()
{
    ...
    RegisterCreatureAI(npc_burning_brazier);
    RegisterCreatureAI(npc_achiev_brazier);
