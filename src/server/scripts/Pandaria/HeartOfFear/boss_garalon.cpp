    ...
    public:
        ...
        struct boss_garalonAI : public BossAI
        {
            ...
            void SummonBody()
            {
                ...
                {
                    body->EnterVehicle(me, BODY_SEAT);
...
class spell_garalon_mend_leg_trigger : public SpellScript
{
    ...
    void HandleHit()
    {
        ...
        GetHitUnit()->RemoveUnitFlag(UnitFlags(UNIT_FLAG_IMMUNE_TO_PC | UNIT_FLAG_IMMUNE_TO_NPC | UNIT_FLAG_NOT_SELECTABLE));
    }
...
class spell_garalon_borken_leg : public SpellScript
{
    ...
    void HandleHit()
    {
        ...
        {
            uint32 damage = target->CountPctFromMaxHealth(GetSpellInfo()->GetEffect(EFFECT_2)->BasePoints);
...
void AddSC_boss_garalon()
{
    ...
    RegisterAuraScript(spell_garalon_pheromones_dummy);
    RegisterSpellScript(spell_garalon_furious_swipe);
    RegisterSpellScript(spell_garalon_pheromones_forcecast);
    RegisterSpellScript(spell_garalon_mend_leg_trigger);
    RegisterSpellScript(spell_garalon_mend_leg);
    RegisterSpellScript(spell_garalon_crush_trigger);
    RegisterSpellScript(spell_garalon_damaged);
    RegisterSpellScript(spell_garalon_pheromones_summon);
    RegisterSpellScript(spell_garalon_pheromones_trail_dmg);
    RegisterSpellScript(spell_garalon_pheromones_switch);
    RegisterSpellScript(spell_garalon_pheromones_damage_eff);
    RegisterSpellScript(spell_garalon_borken_leg);
}
