...
enum SpellIds
{
    ...
    SPELL_DRUID_RAGE_OF_THE_SLEEPER                 = 200851,
    ...
    void HandleProc(AuraEffect const* aurEff, ProcEventInfo& /*eventInfo*/)
    {
        ...
        if (Unit* caster = GetCaster())
        {
            ...
            case TALENT_SPEC_MONK_BATTLEDANCER:
                caster->CastCustomSpell(SPELL_INTELLECT, SPELLVALUE_BASE_POINT0, _amount, caster, true, nullptr, aurEff);
                break;
            ...
            case TALENT_SPEC_MONK_MISTWEAVER:
                caster->CastCustomSpell(SPELL_AGILITY, SPELLVALUE_BASE_POINT0, _amount, caster, true, nullptr, aurEff);
                break;
...
class spell_arti_pri_sphere_of_insanity_summon : public SpellScript
{
    PrepareSpellScript(spell_arti_pri_sphere_of_insanity_summon);
    ...
    void Register() override
    {
        OnEffectLaunch += SpellEffectFn(spell_arti_pri_sphere_of_insanity_summon::HandleSummon, EFFECT_0, SPELL_EFFECT_SUMMON);
    }
};

// 194024 - Thrive in the Shadows
class spell_arti_pri_thrive : public SpellScript
{
    PrepareSpellScript(spell_arti_pri_thrive);
    ...
    void Register()
    {
        OnCast += SpellCastFn(spell_arti_pri_thrive::HandleOnCast);
    }
};
...
void AddSC_artifact_spell_scripts()
{
    ...
    RegisterSpellScript(spell_arti_pri_thrive);
