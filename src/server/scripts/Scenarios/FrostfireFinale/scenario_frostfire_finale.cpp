...
struct scenario_frostfire_finale : public InstanceScript
{
    ...
    void OnCompletedCriteriaTree(CriteriaTree const* tree) override
    {
        ...
        case  CRITERIA_TREE_SPEAK_WITH_DUROTAN:
            events.ScheduleEvent(CRITERIA_TREE_SPEAK_WITH_DUROTAN, 40000);
        ...
        case  CRITERIA_TREE_PROTECT_DREK_THAR:
            ...
            events.ScheduleEvent(CRITERIA_TREE_SURVIVE_WAVE_3, 14000);
            break;
    ...
    void Update(uint32 diff) override
    {
        ...
        case CRITERIA_TREE_SPEAK_WITH_DUROTAN:
        {
            ...
            events.ScheduleEvent(DATA_WAVE_1_1, 29000);
            //1.36
            if (Creature* durotan = GetCreature(NPC_DUROTAN_76484))
            {
...
struct npc_thrall_76488 : public ScriptedAI
{
    ...
    {
        events.ScheduleEvent(SPELL_DAZED,  5000);
    }
...
struct npc_malgrim_stormhand_76630 : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        events.ScheduleEvent(SPELL_MASSIVE_SHOCKWAVE,  10000);
        events.ScheduleEvent(SPELL_DISENGAGE, 15000);
    }
...
struct npc_iron_clusterpult_76629 : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        events.ScheduleEvent(SPELL_CLUSTERPULT_SHOT, 5000);
        events.ScheduleEvent(SPELL_LEFT_PISTON, 10000);
        events.ScheduleEvent(SPELL_RIGHT_PISTON, 15000);
        events.ScheduleEvent(SPELL_PUNCH, 20000);
    }
...
struct npc_maggoc_76491 : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*attacker*/) override
    {
        events.ScheduleEvent(SPELL_AVALANCHE_PALM, 5000);
        events.ScheduleEvent(SPELL_WILD_THRASHING, 10000);
    }
