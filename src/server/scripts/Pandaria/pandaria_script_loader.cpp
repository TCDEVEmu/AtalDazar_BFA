...
void AddSC_boss_korkron_dark_shamans();
...
{ /*
    ...
    AddSC_boss_ook_ook();
    AddSC_boss_yanzhu_the_uncasked();
    ...
    AddSC_boss_korkron_dark_shamans();
    AddSC_boss_malkorok();
    AddSC_boss_norushen();
    ...
    // FallOfTheramoreHorde
    AddSC_fall_of_theramore_horde();
    AddSC_instance_fall_of_theramore_horde();

    // FallOfTheramoreAlliance
    AddSC_fall_of_theramore_alliance();
