    ...
    public:
        ...
        bool OnGossipHello(Player* player, Creature* creature) override
        {
            ...
            if (player->GetQuestStatus(30480) == QUEST_STATUS_INCOMPLETE)
                AddGossipItemFor(player, GOSSIP_ICON_CHAT, "I'm ready. Begin the ritual.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
        ...
        bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action) override
        {
            ...
            if (action == GOSSIP_ACTION_INFO_DEF + 1)
            {
                ...
                creature->RemoveUnitFlag(UnitFlags(UNIT_NPC_FLAG_QUESTGIVER | UNIT_NPC_FLAG_GOSSIP));
        ...
        struct npc_waterspeaker_goraiAI : public ScriptedAI
        {
            ...
            void SetGUID(ObjectGuid guid, int32 /*type*/) override
            {
                ...
                phaseTimer = 10000;
                Talk(0);
                me->AddNpcFlag(NPCFlags(UNIT_NPC_FLAG_QUESTGIVER | UNIT_NPC_FLAG_GOSSIP));
            }
            ...
            void UpdateAI(uint32 diff) override
            {
                ...
                if (phaseTimer <= diff)
                {
                    ...
                    {
                        Talk(6, ObjectAccessor::GetPlayer(*me, playerGUID));
                        phaseTimer = 6000;
                    }
                    else if (phase == 8)
                    {
                ...
                if (auto player = killer->GetCharmerOrOwnerPlayerOrPlayerItself())
                {
                    if (player->GetQuestStatus(30571) == QUEST_STATUS_INCOMPLETE)
                    {
                        ...
                        for (auto&& slave : clist)
                        {
                            ...
                            slave->AI()->Talk(0);
                            Position pos;
                            slave->GetRandomNearPosition(30.f);
    ...
    public:
        ...
        bool OnGossipHello(Player* player, Creature* creature) override
        {
            if (player->GetQuestStatus(30967) == QUEST_STATUS_INCOMPLETE)
                AddGossipItemFor(player, GOSSIP_ICON_CHAT, "There's still hope - Gorai is still alive, to the south. Go!", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
    ...
    public:
        ...
        bool OnGossipHello(Player* player, Creature* creature) override
        {
            if (player->GetQuestStatus(QUEST_UNBELIEVABLE) == QUEST_STATUS_INCOMPLETE)
                AddGossipItemFor(player, GOSSIP_MENU_SENTINEL, 0, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
        ...
        bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action) override
        {
            ...
            if (action == GOSSIP_ACTION_INFO_DEF + 1)
            {
                ...
                creature->GetScheduler().Schedule(Seconds(3), [this, creature](TaskContext /*context*/)
                    { creature->AI()->Talk(SAY_SENTINEL_2); creature->HandleEmoteCommand(EMOTE_ONESHOT_SHOUT); });
                creature->GetScheduler().Schedule(Seconds(5), [this, creature](TaskContext /*context*/)
                    { creature->CastSpell(creature, SPELL_POSSESSED_BY_RAGE); });
                creature->GetScheduler().Schedule(Seconds(1), [this, creature, player](TaskContext /*context*/)
                    { creature->SetFaction(14); creature->Attack(player, true);});
            }
    ...
    public:
        ...
        struct npc_lorewalker_cho_bashon_summonedAI : public ScriptedAI
        {
            ...
            void IsSummonedBy(Unit* summoner) override
            {
                ...
                AddTimedDelayedOperation(4800, [this]() -> void
                {
                    Talk(SAY_SPECIAL_1);
                    ...
                    AddTimedDelayedOperation(me->GetSplineDuration(), [this]() -> void
                    {
                        ...
                        AddTimedDelayedOperation(2000, [this]() -> void
                        {
                            ...
                            AddTimedDelayedOperation(me->GetSplineDuration(), [this]() -> void
                            {
                                ...
                                AddTimedDelayedOperation(2000, [this]()
                                {
                                    init.Path().clear();
    ...
    public:
        ...
        struct npc_xuen_celestial_experienceAI : public ScriptedAI
        {
            ...
            void IsSummonedBy(Unit* summoner) override
            {
                ...
                AddTimedDelayedOperation(6250, [this]() -> void
                {
                    if (Creature* TaranZhu = ObjectAccessor::GetCreature(*me, cList[0]))
                ...
                AddTimedDelayedOperation(11000, [this]() -> void
                {
                    ...
                    if (Player* pCaster = ObjectAccessor::GetPlayer(*me, summonerGUID))
                    {
                        ...
                        AddTimedDelayedOperation(4000, [this, pCaster]() -> void
                        {
                        ...
                        AddTimedDelayedOperation(12200, [this]() -> void
                        {
                ...
                case NPC_SPIRIT_OF_VIOLENCE:
                    ...
                    AddTimedDelayedOperation(5000, [this]() -> void
                    {
                        ...
                        if (Player* pCaster = ObjectAccessor::GetPlayer(*me, summonerGUID))
                        {
                            ...
                            AddTimedDelayedOperation(5000, [this, pCaster]() -> void
                            {
                            ...
                            AddTimedDelayedOperation(6600, [this]() -> void
                            {
                                if (Creature* Anduin = ObjectAccessor::GetCreature(*me, cList[2]))
                                    Anduin->AI()->Talk(SAY_SPECIAL_2);
                            });

                            AddTimedDelayedOperation(13500, [this]() -> void
                            {
                                if (Creature* TaranZhu = ObjectAccessor::GetCreature(*me, cList[0]))
                    ...
                    case NPC_SPIRIT_OF_ANGER:
                        ...
                        AddTimedDelayedOperation(14000, [this]() -> void
                        {
                            if (Player* pCaster = ObjectAccessor::GetPlayer(*me, summonerGUID))
                            {
                                ...
                                AddTimedDelayedOperation(3000, [this, pCaster]() -> void
                                {
                                ...
                                AddTimedDelayedOperation(14000, [this, pCaster]() -> void
                                {
                                    if (Creature* Anduin = ObjectAccessor::GetCreature(*me, cList[2]))
                                ...
                                AddTimedDelayedOperation(9300, [this, pCaster]() -> void
                                {
                                    if (Creature* Anduin = ObjectAccessor::GetCreature(*me, cList[2]))
                                ...
                                AddTimedDelayedOperation(6700, [this, pCaster]() -> void
                                {
                                    if (Creature* Zhi = ObjectAccessor::GetCreature(*me, cList[1]))
                                        Zhi->AI()->Talk(SAY_SPECIAL_2);
                                });

                                AddTimedDelayedOperation(7000, [this, pCaster]() -> void
                                {
                                    if (Creature* Anduin = ObjectAccessor::GetCreature(*me, cList[2]))
...
struct npc_varatus_the_conqueror : public ScriptedAI
{
    npc_varatus_the_conqueror(Creature* creature) : ScriptedAI(creature) { }
...
struct hozen_grind_baseAI : public ScriptedAI
{
    hozen_grind_baseAI(Creature* creature) : ScriptedAI(creature) { }
...
// Ookin Shaman 60752
struct npc_ooking_shaman : public ScriptedAI
{
    npc_ooking_shaman(Creature* creature) : ScriptedAI(creature) { }
...
struct npc_silverback_piker : public ScriptedAI
{
    npc_silverback_piker(Creature* creature) : ScriptedAI(creature) { }
...
void AddSC_kun_lai_summit()
{
    ...
    RegisterCreatureAI(npc_terracotta_gladiator);
    RegisterCreatureAI(npc_terracotta_defender);
    RegisterCreatureAI(npc_upland_raven);
    RegisterCreatureAI(npc_zandalari_warrior);
    RegisterCreatureAI(npc_hungry_yeti);
    RegisterCreatureAI(npc_mischievous_snow_sprite);
    RegisterCreatureAI(npc_tomb_guardian);
    // Quest scripts
    ...
    RegisterCreatureAI(npc_varatus_the_conqueror);
    RegisterCreatureAI(npc_kota_kon);
    RegisterCreatureAI(npc_korda_torros);
    RegisterCreatureAI(npc_borginn_darkfist);
    RegisterCreatureAI(npc_scritch);
    RegisterCreatureAI(npc_the_yowler);
    RegisterCreatureAI(npc_kun_lai_grandpa_grumplefloot);
    RegisterCreatureAI(npc_kunlai_old_poof_poof);
    RegisterCreatureAI(npc_ooking_shaman);
    RegisterCreatureAI(npc_silverback_piker);
    RegisterCreatureAI(npc_broketooth_leaper);

    new go_yaungol_banner();

    RegisterAuraScript(spell_summ_lorewalker_cho_bashon);
    RegisterAuraScript(spell_celestial_experience_whirlwind_of_anger);
    RegisterSpellScript(spell_celestial_experience_devastation);
    RegisterSpellScript(spell_kunlai_release_old_poot_poot);
