    ...
    public:
        ...
        class spell_hof_retreat_AuraScript : public AuraScript
        {
            ...
            void OnApply(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
            {
                ...
                {
                    owner->AddUnitFlag(UnitFlags(UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_IMMUNE_TO_PC));
            ...
            void OnRemove(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
            {
                if (Creature* owner = GetOwner()->ToCreature())
                {
                    owner->RemoveUnitFlag(UnitFlags(UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_IMMUNE_TO_PC));
...
void AddSC_boss_shekzeer()
{
    ...
    RegisterCreatureAI(npc_heart_of_fear);
    ...
    RegisterAuraScript(spell_servant_of_the_empress);
    RegisterAuraScript(spell_heart_of_fear_selector_aura);
    RegisterAuraScript(spell_windblade_fixate_aura);
    RegisterSpellScript(spell_eyes_of_the_empress);
    RegisterSpellScript(spell_dissonance_field_corruption);
    RegisterSpellScript(spell_heart_of_fear_selector);
    RegisterSpellScript(spell_windblade_fixate);
    /*
