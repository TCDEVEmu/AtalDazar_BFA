...
struct npc_high_marshal_twinbraid : public ScriptedAI
{
    npc_high_marshal_twinbraid(Creature* creature) : ScriptedAI(creature) { }
...
struct npc_warlord_bloodhilt : public ScriptedAI
{
    npc_warlord_bloodhilt(Creature* creature) : ScriptedAI(creature) { }
...
struct npc_stoneplow_envoy : public ScriptedAI
{
    ...
    void Reset() override
    {
        ...
        me->SetHealth(46087);
        script_timer = 0, player_guid.Clear();
    }
    ...
    void SpellHit(Unit* caster, const SpellInfo* spell) override
    {
        if (spell->Id == 111446 && me->HasAura(108806))
        {
            ...
            {
                player->KilledMonsterCredit(58955);
    ...
    public:
        ...
        bool OnGossipHello(Player* player, Creature* creature) override
        {
            ...
            if ((player->GetQuestStatus(QUEST_THE_LORD_RECLAIMER) == QUEST_STATUS_INCOMPLETE && creature->GetEntry() == NPC_LYALIA) || (player->GetQuestStatus(QUEST_FOR_FAMILY) == QUEST_STATUS_INCOMPLETE && creature->GetEntry() == NPC_KOR_BLOODTUSK))
                AddGossipItemFor(player, GOSSIP_ICON_CHAT, "It`s trap!", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
...
struct npc_groundbreaker_brojai : public ScriptedAI
{
    npc_groundbreaker_brojai(Creature* creature) : ScriptedAI(creature) { }
    ...
    public:
        ...
        bool OnGossipHello(Player* player, GameObject* go) override
        {
            ...
            if (Creature* narjon = player->SummonCreature(NPC_NARJON, { -1126.79f, 1368.609f, 18.94868f, 5.59949f }))
            {
                ...
                narjon->AddUnitFlag(UNIT_FLAG_IMMUNE_TO_PC);
                narjon->AI()->Talk(0);
                narjon->GetScheduler().Schedule(Seconds(5), [this, narjon, go](TaskContext /*context*/)
                {
                ...
                narjon->GetScheduler().Schedule(Seconds(5), [this, narjon, guid](TaskContext /*context*/)
                {
                    narjon->SetHomePosition(narjon->GetPosition());
                    narjon->RemoveUnitFlag(UNIT_FLAG_IMMUNE_TO_PC);
...
struct npc_na_lek : public ScriptedAI
{
    ...
    void sGossipSelect(Player* player, uint32 /*sender*/, uint32 /*action*/)
    {
        ...
        AddTimedDelayedOperation(10000, [this, guid]() -> void
        {
        ...
        AddTimedDelayedOperation(18000, [this, guid]() -> void
        {
            if (Creature* brojai = me->FindNearestCreature(58606, 50.0f))
            ...
            if (Player* player = ObjectAccessor::GetPlayer(*me, guid))
            {
                for (auto&& guid : summons)
                {
                    ...
                    {
                        summon->RemoveUnitFlag(UnitFlags(UNIT_FLAG_IMMUNE_TO_PC | UNIT_FLAG_IMMUNE_TO_NPC));
        ...
        // reset event
        AddTimedDelayedOperation(120000, [this]() -> void
        {
            summons.DespawnAll();
            me->DespawnOrUnsummon();
        });
...
struct npc_the_bell_peaks_start : public ScriptedAI
{
    ...
    void sGossipSelect(Player* player, uint32 /*sender*/, uint32 /*action*/)
    {
        ...
        if (starter)
        {
            ...
            {
                AddTimedDelayedOperation(1000, [this, starter]() -> void
                    { starter->AI()->Talk(0); });
                AddTimedDelayedOperation(15000, [this, starter]() -> void
                    { starter->AI()->Talk(1); });
                AddTimedDelayedOperation(20000, [this, starter]() -> void
                    { starter->AI()->Talk(2); });
                AddTimedDelayedOperation(20000, [this, starter]() -> void
                    { starter->AI()->Talk(3); });
                AddTimedDelayedOperation(95000, [this, starter]() -> void
                    { starter->AI()->Talk(4); });
                AddTimedDelayedOperation(5000, [this, starter]() -> void
                    { starter->AI()->Talk(5); });
                AddTimedDelayedOperation(30000, [this, starter, guid, kite]() -> void
                {
            ...
            {
                AddTimedDelayedOperation(2000, [this, starter]() -> void
                    { starter->AI()->Talk(0); });
                AddTimedDelayedOperation(15000, [this, starter]() -> void
                    { starter->AI()->Talk(1); });
                AddTimedDelayedOperation(15000, [this, starter]() -> void
                ...
                AddTimedDelayedOperation(20000, [this, starter]() -> void
                    { starter->AI()->Talk(7); });
                AddTimedDelayedOperation(60000, [this, starter]() -> void
                    { starter->AI()->Talk(8); });
                AddTimedDelayedOperation(5000, [this, starter]() -> void
                    { starter->AI()->Talk(9); });
                AddTimedDelayedOperation(7000, [this, starter]() -> void
                    { starter->AI()->Talk(10); });
                AddTimedDelayedOperation(5000, [this, starter, guid, kite]() -> void
                {
                    if (Player* player = ObjectAccessor::GetPlayer(*starter, guid))
...
struct npc_lorekeeper_vaeldrin : public ScriptedAI
{
    ...
    void Reset()
    {
        if (me->GetAreaId() == 6009)
            me->HandleEmoteCommand(EMOTE_STATE_READ);
    }
    ...
    void sQuestAccept(Player* player, Quest const* quest)
    {
        ...
        std::function<void()> reset = [this]()
        {
            ...
            if (Creature* lyalia = me->FindNearestCreature(58821, 50.0f))
            {
                ...
                lyalia->AddNpcFlag(UNIT_NPC_FLAG_GOSSIP);
            }
        };
        ...
        if (quest->GetQuestId() == 30348 && me->GetAreaId() == 6009)
        {
            ...
            vaeldrinNew->RemoveNpcFlag(UNIT_NPC_FLAG_GOSSIP);
            vaeldrinNew->HandleEmoteCommand(EMOTE_ONESHOT_NONE);
            AddTimedDelayedOperation(2000, [this, vaeldrinNew]() -> void
            {
                vaeldrinNew->AI()->Talk(0);
            });
            AddTimedDelayedOperation(5000, [this, vaeldrinNew]() -> void
            {
            ...
            AddTimedDelayedOperation(8000, [this, vaeldrinNew, playerGuid]() -> void
            {
            ...
            AddTimedDelayedOperation(2000, [this, vaeldrinNew, reset]() -> void
            {
                vaeldrinNew->HandleEmoteCommand(EMOTE_STATE_READ);
        ...
        if (quest->GetQuestId() == 30445 && me->GetAreaId() == 6016)
        {
            ...
            lyalia->RemoveNpcFlag(UNIT_NPC_FLAG_GOSSIP);
            ...
            AddTimedDelayedOperation(3000, [this, vaeldrinNew]() -> void
            {
                vaeldrinNew->AI()->Talk(1);
            });
            AddTimedDelayedOperation(5000, [this, vaeldrinNew]() -> void
            ...
            AddTimedDelayedOperation(1000, [this, vaeldrinNew]() -> void
            {
                vaeldrinNew->HandleEmoteCommand(EMOTE_ONESHOT_EAT);
            });
            AddTimedDelayedOperation(5000, [this, vaeldrinNew, lyaliaNew]() -> void
            {
                vaeldrinNew->CastSpell(lyaliaNew, 111849);
            });
            AddTimedDelayedOperation(7000, [this, vaeldrinNew, lyaliaNew]() -> void
            {
                lyaliaNew->RemoveUnitFlag2(UNIT_FLAG2_FEIGN_DEATH);
            });
            AddTimedDelayedOperation(2000, [this, vaeldrinNew, lyaliaNew, playerGuid]() -> void
            {
                lyaliaNew->AI()->Talk(0);
            ...
            AddTimedDelayedOperation(5000, [this, vaeldrinNew, lyaliaNew, reset]() -> void
            {
...
void AddSC_krasarang_wilds()
{
    ...
    RegisterCreatureAI(npc_shieldwall_footman);
    RegisterCreatureAI(npc_krasari_tormentor);
    RegisterCreatureAI(npc_krasari_runekeeper);
    RegisterCreatureAI(npc_weeping_horror);
    RegisterCreatureAI(npc_bilgewater_sapper);
    RegisterCreatureAI(npc_viceclaw_scuttler);
    RegisterCreatureAI(npc_dominance_grunt);
    RegisterCreatureAI(npc_elder_seadragon);
    RegisterCreatureAI(npc_sunwalker_scout);
    RegisterCreatureAI(npc_dojani_dominator);
    RegisterCreatureAI(npc_dojani_enforcer);
    RegisterCreatureAI(npc_dojani_surveyor);
    RegisterCreatureAI(npc_dojani_reclaimer);
    RegisterCreatureAI(npc_riverblade_slayer);
    RegisterCreatureAI(npc_sha_of_despair);
    RegisterCreatureAI(npc_echo_of_despair);
    RegisterCreatureAI(npc_source_of_despair);
    RegisterCreatureAI(npc_child_of_chi_ji_krasarang);
    RegisterCreatureAI(npc_student_of_chi_ji);
    RegisterCreatureAI(npc_alliance_landing_boat);
    RegisterCreatureAI(npc_varian_wrynn_krasarang_landing);
    RegisterCreatureAI(npc_hilda_hornswaggle_krasarang_landing);
    RegisterCreatureAI(npc_horde_landing_boat);
    RegisterCreatureAI(npc_garrosh_hellscream_krasarang_landing);
    RegisterCreatureAI(npc_stoneplow_envoy);
    RegisterCreatureAI(npc_nahassa);
    RegisterCreatureAI(npc_high_marshal_twinbraid);
    RegisterCreatureAI(npc_warlord_bloodhilt);
    RegisterCreatureAI(npc_groundbreaker_brojai);
    RegisterCreatureAI(npc_krasarang_wilds_sunwalker_dezco_reclaimer);
    RegisterCreatureAI(npc_lorewalker_cho_wanderers_festival);
    RegisterCreatureAI(npc_frenzied_reef_shark);
    RegisterCreatureAI(npc_na_lek);
    RegisterCreatureAI(npc_the_bell_peaks_start);
    RegisterCreatureAI(npc_lorekeeper_vaeldrin);
    
    new go_mysterious_whirlpool();

    RegisterSpellScript(spell_call_of_despair_target_picker);
    RegisterSpellScript(spell_call_of_despair_missle);
    RegisterSpellScript(spell_bloodhilt_brutal_charge);

    RegisterAuraScript(spell_krasarang_landing_cinematic);
    RegisterAuraScript(spell_chaingun);
    RegisterAuraScript(spell_cannonball_spin);
